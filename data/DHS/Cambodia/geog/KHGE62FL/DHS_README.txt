...
DHSREGCO = integer region code associated with the DHS region created for sampling.  This variable will match the hv024 variable of the recode file.
*NOTE:  In older templates, REPAIR1DHS was used.   Thise field has been replaced by DHSREGCO and is no longer used. 

DHSREGNA = name associated with the DHS region created for sampling.  This variable will match the hv024 variable of the recode file.
...
*NOTE: If coordinates are missing altitude is listed as "9999"
