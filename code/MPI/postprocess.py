...
# %%% harmonized cluster-level MPI based on Cambodia DHS 2005 excluding wall
...
# %%% harmonized cluster-level MPI based on Cambodia DHS 2010 excluding wall
survey = 'khm_dhs10_cot_nowall'
spatial_res = 'clust'
n_spatial_unit = 611
mpi_info_df = mpi_info_to_csv(survey, spatial_res, n_spatial_unit)
...
# %%% harmonized cluster-level MPI based on Cambodia DHS 2014 excluding wall
survey = 'khm_dhs14_cot_nowall'
spatial_res = 'clust'
n_spatial_unit = 611
mpi_info_df = mpi_info_to_csv(survey, spatial_res, n_spatial_unit)
