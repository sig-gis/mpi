...
*** Working Folder Path ***
global path_in "../../data/MPI/khm_dhs00_test" 	  
...
/* Step 1 is skipped as it would be the same as in `khm_dhs00_microdata_test.do`. */
...
use "$path_in/KHM00_merged_procd.dta", clear 
